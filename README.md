...
## Решение
Приложение доступно по адресу: http://89.169.130.147/hw/store/

Дополнительно:
После релиза или фикс-релиза создается pull request с изменениями CHANGELOG.md для ветки main, его необходимо принять, чтобы CHANGELOG.md стал актуальным.
